...
import com.ecocp.capstoneenvirotrack.databinding.FragmentCncPaymentBinding
...
class CncPaymentFragment : Fragment() {

    private var _binding: FragmentCncPaymentBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentCncPaymentBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnPayStripe.setOnClickListener {
            val phpAmount = 50 // CNC application fee
                ...
                if (!documents.isEmpty) {
                    ...
                    latestDoc.update(paymentData)
                        .addOnSuccessListener {
                            ...
                            findNavController().navigate(R.id.action_cncPayment_to_cncReview)
                        }
                        .addOnFailureListener { e ->
                            Toast.makeText(requireContext(), "Failed to update document: ${e.message}", Toast.LENGTH_LONG).show()
                        }
                } else {
                    Toast.makeText(requireContext(), "No existing CNC application found.", Toast.LENGTH_SHORT).show()
                }
            }
            .addOnFailureListener { e ->
