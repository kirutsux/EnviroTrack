...
import com.ecocp.capstoneenvirotrack.databinding.FragmentPtoPaymentBinding
...
class PtoPaymentFragment : Fragment() {

    private var _binding: FragmentPtoPaymentBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentPtoPaymentBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Click to start Stripe payment
        binding.btnPayStripe.setOnClickListener {
            val phpAmount = 50 // PTO application fee
    ...
    private fun savePaymentToFirestore() {
        ...
        val paymentData = mapOf(
            ...
            "paymentTimestamp" to Timestamp.now()
        )

        // Update the latest PTO document under this UID
                ...
                if (!documents.isEmpty) {
                    ...
                    latestDoc.update(paymentData)
                        .addOnSuccessListener {
                            ...
                            findNavController().navigate(R.id.action_payment_to_ptoReview)
                        }
                        .addOnFailureListener { e ->
                            Toast.makeText(requireContext(), "Failed to update document: ${e.message}", Toast.LENGTH_LONG).show()
                        }
                } else {
                    Toast.makeText(requireContext(), "No existing PTO application found.", Toast.LENGTH_SHORT).show()
                }
            }
            .addOnFailureListener { e ->
